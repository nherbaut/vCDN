...
rects1 = ax.bar(ind, [100*data_means[x][0]/data_means[x][0] for x in sorted(data_means)], width, color='r', yerr=[data_std[x][0]/data_std[x][0] for x in sorted(data_std)])
rects2 = ax.bar(ind+width, [100*data_means[x][1]/data_means[x][0] for x in sorted(data_means)], width, color='g', yerr=[data_std[x][1]/data_std[x][0] for x in sorted(data_std)])
rects3 = ax.bar(ind+2*width, [100*data_means[x][2]//data_means[x][0] for x in sorted(data_means)], width, color='b', yerr=[data_std[x][2]/data_std[x][0] for x in sorted(data_std)])
